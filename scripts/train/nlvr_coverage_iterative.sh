...
OUTPUT_FILE=./resources/data/nlvr/processed/ERM_DATAGEN/train_erm1.json
...
CONFIGFILE=training_config/nlvr_mml_parser.jsonnet
export TRAIN_DATA=./resources/data/nlvr/processed/ERM_DATAGEN/train_erm1.json
# HYPER-PARAMETERS
export MDS=14
# SERIALIZATION PATH
...
### GENERATE DATA from ERM
INPUT_FILE=./resources/data/nlvr/processed/train_grouped.json
OUTPUT_FILE=./resources/data/nlvr/processed/ERM_DATAGEN/train_erm${ITER}.json
...
CONFIGFILE=training_config/nlvr_mml_parser.jsonnet
export TRAIN_DATA=./resources/data/nlvr/processed/ERM_DATAGEN/train_erm${ITER}.json
# HYPER-PARAMETERS
export MDS=16
# SERIALIZATION PATH
