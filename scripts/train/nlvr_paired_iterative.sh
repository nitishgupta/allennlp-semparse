...
OUTPUT_FILE=./resources/data/nlvr/processed/PAIRED_DATAGEN/train_pair${ITER}.json
...
CONFIGFILE=training_config/nlvr_mml_parser.jsonnet
export TRAIN_DATA=./resources/data/nlvr/processed/PAIRED_DATAGEN/train_pair${ITER}.json
# HYPER-PARAMETERS
export MDS=14
# SERIALIZATION PATH
