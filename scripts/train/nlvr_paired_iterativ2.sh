...
export CUDA=-1
mkdir -p ./resources/data/nlvr/processed/PAIRED_DATAGEN
...
export MDS=12
# SERIALIZATION PATH
MML_0_SERDIR=./resources/checkpoints/mml_parser/nlvr/agenda_v6_ML11/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
allennlp train --include-package allennlp_semparse  -s ${MML_0_SERDIR} ${CONFIGFILE}
######

###   ITERATION 1 -- Paired parser   ###
ITER=1
...
export MDS=14
# SERIALIZATION PATH
ERM_1_SERDIR=./resources/checkpoints/paired_parser/nlvr/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
allennlp train --include-package allennlp_semparse  -s ${ERM_1_SERDIR} ${CONFIGFILE}
######

### GENERATE DATA from Paired-model
INPUT_FILE=./resources/data/nlvr/processed/train_grouped.json
OUTPUT_FILE=./resources/data/nlvr/processed/PAIRED_DATAGEN/train_pairS${SEED}_${ITER}.json
MODEL_TAR=${ERM_1_SERDIR}/model.tar.gz
time python scripts/nlvr_v2/generate_data_from_paired_model.py ${INPUT_FILE} ${OUTPUT_FILE} ${MODEL_TAR}
######

###   ITERATION 1 -- MML parser   ###
CONFIGFILE=training_config/nlvr_mml_parser.jsonnet
export TRAIN_DATA=./resources/data/nlvr/processed/PAIRED_DATAGEN/train_pairS${SEED}_${ITER}.json
# HYPER-PARAMETERS
export MDS=14
# SERIALIZATION PATH
MML_1_SERDIR=./resources/checkpoints/mml_parser/nlvr/agenda_v6_ML11/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
...
export MDS=16
# SERIALIZATION PATH
ERM_2_SERDIR=./resources/checkpoints/paired_parser/nlvr/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
...
export MDS=16
# SERIALIZATION PATH
MML_2_SERDIR=./resources/checkpoints/mml_parser/nlvr/agenda_v6_ML11/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
...
export MDS=18
# SERIALIZATION PATH
ERM_3_SERDIR=./resources/checkpoints/paired_parser/nlvr/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
...
export MDS=18
# SERIALIZATION PATH
MML_3_SERDIR=./resources/checkpoints/mml_parser/nlvr/agenda_v6_ML11/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
...
export MDS=20
# SERIALIZATION PATH
ERM_4_SERDIR=./resources/checkpoints/paired_parser/nlvr/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
...
###   ITERATION 4 -- MML parser   ###
CONFIGFILE=training_config/nlvr_mml_parser.jsonnet
export TRAIN_DATA=./resources/data/nlvr/processed/PAIRED_DATAGEN/train_pairS${SEED}_${ITER}.json
# HYPER-PARAMETERS
export MDS=20
# SERIALIZATION PATH
MML_4_SERDIR=./resources/checkpoints/mml_parser/nlvr/agenda_v6_ML11/PI_S_${SEED}-MDS_${MDS}-Iter${ITER}
