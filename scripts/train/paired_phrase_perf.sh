...
BASIC_ERM2=./resources/checkpoints/nlvr/basicerm_NEWLANG/SEED_1337/ERM/Iter5_MDS22/predictions/${SPLIT}-predictions.jsonl
...
PAIRED_V6=./resources/checkpoints/nlvr/pairedv6_NEWLANG_T07_P1M2/SEED_1337/ERM/Iter5_MDS22/predictions/${SPLIT}-predictions.jsonl

PAIRED_V7=./resources/checkpoints/nlvr/pairedv7_NEWLANG_T07_P1M2/SEED_42/ERM/Iter5_MDS22/predictions/${SPLIT}-predictions.jsonl
...
python scripts/nlvr_v2/analysis/phrase_based_performance.py ${PHRASES} ${BASIC_ERM} ${PAIRED_V6}
