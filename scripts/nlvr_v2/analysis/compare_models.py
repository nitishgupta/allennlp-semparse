...
def compare_models(
    ...
    print("Model-1")
    print(
        "Num instances: {}  Avg. consistency: {}".format(
            model1.num_instances, model1.avg_consistency
        )
    )
    ...
    print(
        "Num instances: {}  Avg. consistency: {}".format(
            model2.num_instances, model2.avg_consistency
        )
    )

    correct_instance_ids_1 = set(model1.correct_instance_ids)
    correct_instance_ids_2 = set(model2.correct_instance_ids)
    ...
    for idf in correct_1_not_2:
        ...
        print(instance1.best_logical_form)
        print(instance2.best_logical_form)
        print()
